...
;(function($){
	...
	p.setup = function(){
		...
		this.$next = $('<div><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 200" width="30" height="30"><title>bm_next</title><polyline points="0 0 100 100 0 200"/></svg></div>')
		...
		this.$prev = $('<div><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 200" width="30" height="30"><title>bm_prev</title><polyline points="100 200 0 100 100 0"/></svg></div>')
