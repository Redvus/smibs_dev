ymaps.ready(init);
	...
	// Библиотека №9
	var library9 = new ymaps.Placemark([53.188845, 50.085195], {
		iconContent: "Библиотека №9",
		hintContent: "Россия, Самара, ул. Ленинградская, 7<br>Руководитель: Лупинос Татьяна Александровна<br>Телефоны: 221-23-93<br>Время работы: с 11 до 19 ч. Выходные: Пт., Сб."
	}, {
		preset: "islands#redStretchyIcon"
	});
